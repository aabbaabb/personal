...
var adaptUILayout = (function(){
    ...
    var adapt = function(uiWidth){
        ...
        targetDensitydpi = parseInt(targetDensitydpi);
        ...
        if(targetDensitydpi>400){
            ...
            deviceWidth = uiWidth * devicePixelRatio * 160 / 400;
        }
        initialContent   = isiOS 
            ? 'target-densitydpi=device-dpi, width=' + uiWidth + 'px, user-scalable=no'
            : 'target-densitydpi=' +  targetDensitydpi + ', width='+ deviceWidth+', user-scalable=yes';
